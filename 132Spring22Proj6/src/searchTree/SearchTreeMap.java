...
public class SearchTreeMap<K extends Comparable<K>, V>  {
	...
	public List<K> keyList( ) {
		ArrayList<K> treeList = new ArrayList<K>();
		theTree.addKeysToCollection(treeList);
		return treeList;
	}
	...
	public SearchTreeMap<K, V> subMap(K fromKey, K toKey) {
		SearchTreeMap<K,V> treeMap = new SearchTreeMap<K,V>();
		treeMap.theTree = theTree.subTree(fromKey, toKey);
		return treeMap;
	}
}